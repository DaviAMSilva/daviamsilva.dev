...
<p class="perfil-linha2" markdown>Eu sou um cientista da computação, sete vezes medalhista da **[OBMEP]**</p>
...
[:fontawesome-solid-screwdriver-wrench: Projetos](blog/categoria/projetos.md){ .md-button .md-button--primary }
</div>
</div>
</div>
