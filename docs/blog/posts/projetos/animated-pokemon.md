...
description: Papel de parede animado utilizando Pokémon para Wallpaper Engine.
date: 2022-10-11
categories:
  - Projetos
tags:
...
![Animated Pokémon - Ícone contendo Pikachu](https://github.com/DaviAMSilva/AnimatedPokemon/blob/master/preview.gif?raw=true "Animated Pokémon - Ícone"){ align=right }
...
Dessa forma eu fui capaz de publicar meu papel de parede no Steam Workshop onde ele teve um sucesso moderado e foi bem recebido. Até hoje, no meu sistema Linux atual eu ainda o utilizo graças ao plugin [Wallpaper Engine for Kde](https://github.com/catsout/wallpaper-engine-kde-plugin).
